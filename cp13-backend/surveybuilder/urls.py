...
urlpatterns = [
    ...
    # get/delete/patch: randomiser by survey ID
    url(r'^randomiser/(?P<id>[0-9]+)', views.randomiser_info),
    # get/post: randomiser by survey ID
    url(r'^surveys/(?P<id>[0-9]+)/randomiser', views.randomiser_list),
