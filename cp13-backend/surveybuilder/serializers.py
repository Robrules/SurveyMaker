...
from surveybuilder.models import Survey, Randomiser, Block, Question, SocialPostQuestion, ButtonRowQuestion, ButtonQuestion, TextboxQuestionDecimal, TextboxQuestionNumber, TextboxQuestionText, MultiChoiceQuestion, MultiChoice, NumberScaleQuestion, DragAndDropQuestion, DragAndDropChoice, DragAndDropCard
...
class RandomiserSerializer(serializers.ModelSerializer):
    class Meta:
        model = Randomiser
        fields = ['id', 'subset', 'survey']
...
class BlockSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Block
        fields = ['id', 'survey', 'randomiser', 'title', 'description', 'order']
        extra_kwargs = {'description': {'required': False}, 'randomiser': {'required': False}}
