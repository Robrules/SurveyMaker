  ...
  <div class="options">
    ...
    <div class="text-with-button">
      ...
      <toggle-base
        ...
        @handleToggle="
          $store.commit('toggle', { parent: question, key: 'minTitleOn' })
        "
      ></toggle-base>
    </div>
    <div class="text-with-button">
      ...
      <toggle-base
        ...
        @handleToggle="
          $store.commit('toggle', { parent: question, key: 'midTitleOn' })
        "
      ></toggle-base>
    </div>
    <div class="text-with-button">
      ...
      <toggle-base
        ...
        @handleToggle="
          $store.commit('toggle', { parent: question, key: 'maxTitleOn' })
        "
      ></toggle-base>
    </div>
    <line-base class="dark" />
