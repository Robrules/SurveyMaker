<template>
  <div>
    ...
    <h3 v-if="$i18n.locale === 'ur'" style="text-align: right; margin-bottom: 0">
    ...
    <label for="imageURL">{{ $t("qContentArticles.imageLink") }}</label>
    <div class="text-with-button">
      <input
        type="text"
        id="imageURL"
    ...
    <h3>{{ $t("qContentArticles.editablePreview") }}</h3>
