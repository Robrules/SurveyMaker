          ...
          <form class="update-settings">
            ...
            <div class = "row">
              <div class = "column">
                ...
                <input type="text" id="fname" placeholder="Enter first name" v-model="first_name">

                <p class="msg">{{$t("g5.update-last")}}:</p>
                <input type="text" id="lname" placeholder="Enter last name" v-model="last_name">
              </div>
              <div class="column">
                ...
                <div>
                  <input type="password" id="npassword" placeholder="Enter new password" v-model="new_password1" ref="password2">
                  <font-awesome-icon class="eye" v-show="show" @click="showPasswords" icon="eye"/>
                  <font-awesome-icon class="eye" v-show="!show" @click="showPasswords" icon="eye-slash"/>
                </div>
                ...
                <div>
                  <input type="password" id="confirmnpassword" placeholder="Confirm password" v-model="new_password2" ref="password3">
                  <font-awesome-icon class="eye" v-show="show" @click="showPasswords" icon="eye"/>
                  <font-awesome-icon class="eye" v-show="!show" @click="showPasswords" icon="eye-slash"/>
                </div>
              </div>
